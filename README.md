...
ISO-8859-1/2/3/4/5/6/7/8/9/15 and Windows-1251/1252 charset MIME and Markdown, and
...
`text/uri-list`, receive-only `text/x-uri-list` / `text/rtf` / `COMPOUND_TEXT` / ISO-8859-1/2/3/4/5/6/7/8/9/15 / Windows-1251/1252 / Markdown, receive-only desktop file-list MIME (GNOME/Nautilus/KDE/KDE5/Mozilla/KDE suggested-filename), `UTF16_STRING`, `TIMESTAMP`, and `MULTIPLE` (preferring the owner's
